...
//                .build();
        ...
        depositBlock1 = new PathContainer.PathContainerBuilder()
                ...
                .addCurve(new BezierCurve(
                                new Vector2D[]{
                                        new Vector2D(-40, -8), //with 2 blocks (-47, 10)
                                        new Vector2D(5, -11),
                                        new Vector2D(5, -11),
                                        new Vector2D(5, -11),
                                        new Vector2D(5, -11)
        ...
        depositBlock2 = new PathContainer.PathContainerBuilder()
                ...
                .addCurve(new BezierCurve(
                                new Vector2D[]{
                                        new Vector2D(-27.8, -8), //with 2 blocks (-47, 10)
                                        new Vector2D(5, -11),
                                        new Vector2D(5, -11),
                                        new Vector2D(5, -11),
                                        new Vector2D(5, -11)
        ...
        grabBlock3a = new PathContainer.PathContainerBuilder()
                ...
                .addCurve(new BezierCurve(
                                new Vector2D[]{
                                        new Vector2D(4, -30.5), //with 2 blocks (-47, 10)
                                        new Vector2D(5, -20)
                                }
                        ),
                        new ParametricHeading(new double[]{
        ...
        //drive to sub
        followPath(startToSub, 0.05, 0.8);

        //Deposit preload
        lowerArm();

        //Push Block 1
        followPath(pushBlock1, 0.05, 0.8);
        followPath(pushBlock2a, 0.05, 0.8);
        followPath(pushBlock2b, 0.05, 0.8);
        followPath(pushBlock2c, 0.05, 0.8);


        //Grab Block 1
        prepIntake();
        followPath(grabBlock1a, 0.05, 0.8);
        followPath(grabBlock1b, 0.05, 0.8);
        finishIntake();
        prepArm();
        raiseArm();

        //Deposit Block 1
        followPath(depositBlock1, 0.05, 0.8);
        lowerArm();

        //Grab Block 2
        prepIntake();
        followPath(grabBlock2a, 0.15, 0.8);
        followPath(grabBlock2b, 0.05, 0.8);
        finishIntake();
        prepArm();
        raiseArm();

        //Deposit Block 2
        followPath(depositBlock2, 0.05, 0.8);
        lowerArm();

        //Grab Block 3
        prepIntake();
        followPath(grabBlock3a, 0.15, 0.8);
        followPath(grabBlock3b, 0.05, 0.8);
        finishIntake();
        prepArm();
        raiseArm();

        //Deposit Block 2
        followPath(depositBlock3, 0.05, 0.8);
        lowerArm();
...
//    }
    ...
    public void prepArm(){
        ...
        updateCommands(); //TODO removed wait HERE
